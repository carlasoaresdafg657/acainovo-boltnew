  ...
  public: {
    Tables: {
      ...
      custos_produtos: {
        ...
        Relationships: [
          {
            foreignKeyName: "custos_produtos_produto_id_fkey"
            columns: ["produto_id"]
            isOneToOne: false
            referencedRelation: "produtos_fornecedores"
      ...
      faturamento_mensal: {
        Row: {
          ...
          id: string
          lucro_pj_distribuido: number | null
          mes: number
          transferencia_pf: number | null
          user_id: string | null
        }
        Insert: {
          ano: number
